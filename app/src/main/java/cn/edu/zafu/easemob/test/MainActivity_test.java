        ...
        public void run() {
            ...
            try{
               ...
               // String url="http://10.0.0.24/huanxin/index.php";
                String url="https://a1.easemob.com/dianshiju/mdcmoe/users";
                ...
                Toast.makeText(MainActivity_test.this,ex.toString(),Toast.LENGTH_LONG).show();
            }
        }
    };
...
*/
        ...
        try{
            ...
            mOkHttpClient.newCall(request).enqueue(new Callback() {
                ...
                public void onFailure(Request request, IOException e) {
                    ...
                    Toast.makeText(MainActivity_test.this, "注册失败", Toast.LENGTH_SHORT).show();
                }
                @Override
            ...
            Toast.makeText(MainActivity_test.this,"sdf",Toast.LENGTH_LONG).show();
        }
        catch(Exception ex){
            Toast.makeText(MainActivity_test.this,ex.toString(),Toast.LENGTH_LONG).show();
        }
    ...
    private void login() {
        ...
        EMChatManager.getInstance().login(u, p, new EMCallBack() {//回调
            ...
            public void onSuccess() {
                runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        Toast.makeText(MainActivity_test.this, "登陆聊天服务器成功", Toast.LENGTH_SHORT).show();
                        Log.e("TAG", "登陆聊天服务器成功！");
                    }
                });
            }
            ...
            public void onError(int code, String message) {
                Log.e("TAG", "登陆聊天服务器失败！");
                Toast.makeText(MainActivity_test.this, "登录失败！", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void logout() {
        ...
        EMChatManager.getInstance().logout(new EMCallBack() {
            ...
            public void onSuccess() {
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(MainActivity_test.this, "退出聊天服务器成功", Toast.LENGTH_SHORT).show();
                        Log.e("TAG", "退出聊天服务器成功！");
                    }
                });
            }
    ...
    private void voice() {
        if (!EMChatManager.getInstance().isConnected())
            ...
            if (TextUtils.isEmpty(toUser)){
                Toast.makeText(MainActivity_test.this, "请填写接受方账号", Toast.LENGTH_SHORT).show();
                return ;
            }
            Intent intent = new Intent(MainActivity_test.this, VoiceCallActivity.class);
    ...
    private void video() {
        if (!EMChatManager.getInstance().isConnected()) {
            Toast.makeText(MainActivity_test.this, "未连接到服务器", Toast.LENGTH_SHORT).show();
        }
        else {
            String toUser=to.getText().toString();
            if (TextUtils.isEmpty(toUser)){
            ...
            Intent intent = new Intent(MainActivity_test.this, VideoCallActivity.class);
            intent.putExtra("username", toUser);
            intent.putExtra("isComingCall", false);
            startActivity(intent);
        }
